...
* A total of eight different sites were visited by ten team members and collaborators completing a total of 98 dives. 
...
Subsurface temperature recorders (STRs) were recovered and redeployed at east and west bank, each one composed by 4 depths (Fig. 1). Overall,  almost 3 million temperature observations were collected (Table 1)
...
At Buoy 3, located on the East Bank, short term instruments (72h) were deployed to  monitor daily fluctuations in: 
...
<font size="2"> **Figure 2:** Temperature conditions at two transects in FGBNMS (east bank, and west bank) representing a depth gradient (15m, 20m, 25m and 30m). Data were collected from September 2015 to October 2022. However, STR from west Bank - 15m was not recovered. </font>
...
```
NEED TO EDIT THIS TEXT TO FIT ANALYSIS FOR FGB DATA
...
Water chemistry can demonstrate diurnal fluctuations and can provide insight on coral respirations. To investigate this, additional instruments were deployed for a 72-hour diurnal suite that monitored pH, temperature, light and current speed (Fig. 3) at the 15m East Bank site. The SeaFET pH logger, EcoPAR and Tiltmeter collected measurements at 15-minute intervals. 

To accompany and validate the diurnal suite, discrete water samples were collected at three-hour intervals (n=15) using Subsurface Automatic Samplers (SAS, https://www.coral.noaa.gov/accrete/sas/). These samples will be analyzed for Total Alkalinity (TA), Dissolved Inorganic Carbon (DIC), and Spectrophotometric pH (SpecpH). Using these metrics, we can get the calculated values for pCO2 and aragonite saturation state which provide the full suite of carbonate chemistry parameters.
