...
# 3. Get the PAR data  
  ...
  #manual start/stop time of monitoring
   filter(DateTime >= as.POSIXct('2022-10-04 11:00:00', tz='America/Chicago') &
          DateTime <= as.POSIXct('2022-10-07 08:00:00', tz='America/Chicago'))
...
knitr::include_graphics("Pictures/mosaic.jpg")
...
```{r disease, echo=FALSE, out.width = '50%', fig.cap="Figure 8: Colonies sowing lesions at the FGB.", fig.align='center'}

knitr::include_graphics("Pictures/Lesions.jpg")
